    ...
    <main className="page-shell invariant-page">
      <nav className="topbar" aria-label="Навигация">
        ...
        <div className="day-switcher" aria-label="Выбор задания">
          <a href="#day-02">День 2</a><a href="#day-11">День 11</a><a href="#day-12">День 12</a><a href="#day-13">День 13</a><a className="selected" href="#day-14">День 14</a><a href="#day-15">День 15</a>
        </div>
