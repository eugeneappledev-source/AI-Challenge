...
Дни не перезаписывают друг друга: каждый сценарий открывается отдельной лабораторией из общего каталога, а обратная совместимость API отмечена в описаниях заданий.
