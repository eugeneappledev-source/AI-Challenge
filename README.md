...
Нативное iOS-приложение открывается каталогом заданий. День 1 демонстрирует базовый запрос к LLM, День 2 сравнивает свободный ответ с контролируемым JSON, а День 3 решает одну задачу четырьмя способами и передаёт результаты независимому AI-арбитру. Адаптивная web-версия сохраняет сценарий Дня 2 с пищевым ассистентом.
